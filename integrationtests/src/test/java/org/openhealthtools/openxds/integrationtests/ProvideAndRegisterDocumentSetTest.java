...
//		message = message.replace("$XDSDocumentEntry.uniqueId", "urn:uuid:6a15bb1a-ea0e-98e4-3563-ae91b8018476^^^&amp;2.16.756.5.30.1.117.200.10.1&amp;ISO");
		...
		System.out.println("Used a doc1 of " + uuid);
