...
-- 
-- ALTER IGNORE TABLE AdhocQuery DROP INDEX lid_AdhQuery_idx;
-- ALTER IGNORE TABLE Association DROP INDEX lid_Assoc_idx;
-- ALTER IGNORE TABLE AuditableEvent DROP INDEX lid_AUEVENT_idx;
-- ALTER IGNORE TABLE Classification DROP INDEX lid_Class_idx;
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX lid_Node_idx;
-- ALTER IGNORE TABLE ClassScheme DROP INDEX lid_SCHEME_idx;
-- ALTER IGNORE TABLE ExternalIdentifier DROP INDEX lid_EID_idx;
-- ALTER IGNORE TABLE ExternalLink DROP INDEX lid_ExLink_idx;
-- ALTER IGNORE TABLE ExtrinsicObject DROP INDEX lid_EXTOBJ_idx;
-- ALTER IGNORE TABLE Federation DROP INDEX lid_FED_idx;
-- ALTER IGNORE TABLE Organization DROP INDEX lid_ORG_idx;
-- ALTER IGNORE TABLE Registry DROP INDEX lid_Registry_idx;
-- ALTER IGNORE TABLE RegistryPackage DROP INDEX lid_PKG_idx;
-- ALTER IGNORE TABLE Service DROP INDEX lid_Service_idx;
-- ALTER IGNORE TABLE ServiceBinding DROP INDEX lid_BIND_idx;
-- ALTER IGNORE TABLE SpecificationLink DROP INDEX lid_SLnk_idx;
-- ALTER IGNORE TABLE Subscription DROP INDEX lid_SUBS_idx;
-- ALTER IGNORE TABLE User_ DROP INDEX lid_User_idx;
-- ALTER IGNORE TABLE Person DROP INDEX lid_Person_idx;
...
-- ALTER IGNORE TABLE AdhocQuery DROP INDEX id_AdhQuery_idx;
-- ALTER IGNORE TABLE Association DROP INDEX id_Assoc_idx;
-- ALTER IGNORE TABLE AuditableEvent DROP INDEX id_AUEVENT_idx;
-- ALTER IGNORE TABLE Classification DROP INDEX id_Class_idx;
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX id_Node_idx;
-- ALTER IGNORE TABLE ClassScheme DROP INDEX id_SCHEME_idx;
-- ALTER IGNORE TABLE ExternalIdentifier DROP INDEX id_EID_idx;
-- ALTER IGNORE TABLE ExternalLink DROP INDEX id_ExLink_idx;
-- ALTER IGNORE TABLE ExtrinsicObject DROP INDEX id_EXTOBJ_idx;
-- ALTER IGNORE TABLE Federation DROP INDEX id_FED_idx;
-- ALTER IGNORE TABLE Organization DROP INDEX id_ORG_idx;
-- ALTER IGNORE TABLE ObjectRef DROP INDEX id_ObjectRef_idx;
-- ALTER IGNORE TABLE Registry DROP INDEX id_Registry_idx;
-- ALTER IGNORE TABLE RegistryPackage DROP INDEX id_PKG_idx;
-- ALTER IGNORE TABLE Service DROP INDEX id_Service_idx;
-- ALTER IGNORE TABLE ServiceBinding DROP INDEX id_BIND_idx;
-- ALTER IGNORE TABLE SpecificationLink DROP INDEX id_SLnk_idx;
-- ALTER IGNORE TABLE Subscription DROP INDEX id_SUBS_idx;
-- ALTER IGNORE TABLE User_ DROP INDEX id_User_idx;
-- ALTER IGNORE TABLE Person DROP INDEX id_Person_idx;
...
-- ALTER IGNORE TABLE AdhocQuery DROP INDEX home_AdhQuery_idx;
-- ALTER IGNORE TABLE Association DROP INDEX home_Assoc_idx;
-- ALTER IGNORE TABLE AuditableEvent DROP INDEX home_AUEVENT_idx;
-- ALTER IGNORE TABLE Classification DROP INDEX home_Class_idx;
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX home_Node_idx;
-- ALTER IGNORE TABLE ClassScheme DROP INDEX home_SCHEME_idx;
-- ALTER IGNORE TABLE ExternalIdentifier DROP INDEX home_EID_idx;
-- ALTER IGNORE TABLE ExternalLink DROP INDEX home_ExLink_idx;
-- ALTER IGNORE TABLE ExtrinsicObject DROP INDEX home_EXTOBJ_idx;
-- ALTER IGNORE TABLE Federation DROP INDEX home_FED_idx;
-- ALTER IGNORE TABLE Organization DROP INDEX home_ORG_idx;
-- ALTER IGNORE TABLE Registry DROP INDEX home_Registry_idx;
-- ALTER IGNORE TABLE RegistryPackage DROP INDEX home_PKG_idx;
-- ALTER IGNORE TABLE Service DROP INDEX home_Service_idx;
-- ALTER IGNORE TABLE ServiceBinding DROP INDEX home_BIND_idx;
-- ALTER IGNORE TABLE SpecificationLink DROP INDEX home_SLnk_idx;
-- ALTER IGNORE TABLE Subscription DROP INDEX home_SUBS_idx;
-- ALTER IGNORE TABLE User_ DROP INDEX home_User_idx;
-- ALTER IGNORE TABLE Person DROP INDEX home_Person_idx;
...
-- ALTER IGNORE TABLE AffectedObject DROP INDEX id_evId_AFOBJ_idx;
...
-- ALTER IGNORE TABLE AffectedObject DROP INDEX id_AFOBJ_idx;
-- ALTER IGNORE TABLE AffectedObject DROP INDEX evid_AFOBJ_idx;
...
-- ALTER IGNORE TABLE AuditableEvent DROP INDEX lid_AUEVENT_evtTyp;
CREATE INDEX lid_AUEVENT_evtTyp ON AuditableEvent(eventType);

-- name index
-- ALTER IGNORE TABLE Name_ DROP INDEX value_Name_idx;
-- ALTER IGNORE TABLE Name_ DROP INDEX lngval_Name_idx;
CREATE INDEX value_Name_idx ON Name_(value);
CREATE INDEX lngval_Name_idx ON Name_(lang, value);

-- description index
-- ALTER IGNORE TABLE Description DROP INDEX value_Desc_idx;
-- ALTER IGNORE TABLE Description DROP INDEX lngval_Desc_idx;
CREATE INDEX value_Desc_idx ON Description(value);
CREATE INDEX lngval_Desc_idx ON Description(lang, value);

-- UsageDesc index
-- ALTER IGNORE TABLE UsageDescription DROP INDEX value_UsgDes_idx;
-- ALTER IGNORE TABLE UsageDescription DROP INDEX lngval_UsgDes_idx;
CREATE INDEX value_UsgDes_idx ON UsageDescription(value);
CREATE INDEX lngval_UsgDes_idx ON UsageDescription(lang, value);


-- Indexes on Assoc
-- ALTER IGNORE TABLE Association DROP INDEX src_Ass_idx;
-- ALTER IGNORE TABLE Association DROP INDEX tgt_Ass_idx;
-- ALTER IGNORE TABLE Association DROP INDEX type_Ass_idx;
...
-- Indexes on Class
-- ALTER IGNORE TABLE Classification DROP INDEX clsObj_Class_idx;
-- ALTER IGNORE TABLE Classification DROP INDEX node_Class_idx;
...
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX parent_Node_idx;
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX code_Node_idx;
-- ALTER IGNORE TABLE ClassificationNode DROP INDEX path_Node_idx;
...
-- ALTER IGNORE TABLE ExternalIdentifier DROP INDEX ro_EID_idx;
CREATE INDEX ro_EID_idx ON ExternalIdentifier(registryObject);


-- Indexes on ExLink
-- ALTER IGNORE TABLE ExternalLink DROP INDEX uri_ExLink_idx;
...
-- ALTER IGNORE TABLE Organization DROP INDEX parent_ORG_idx;
CREATE INDEX parent_ORG_idx ON Organization(parent);


-- Indexes on PostalAddress
-- ALTER IGNORE TABLE PostalAddress DROP INDEX parent_PstlAdr_idx;
-- ALTER IGNORE TABLE PostalAddress DROP INDEX city_PstlAdr_idx;
-- ALTER IGNORE TABLE PostalAddress DROP INDEX cntry_PstlAdr_idx;
-- ALTER IGNORE TABLE PostalAddress DROP INDEX pCode_PstlAdr_idx;
...
-- ALTER IGNORE TABLE EmailAddress DROP INDEX parent_EmlAdr_idx;
...
-- Indexes on Slot
-- ALTER IGNORE TABLE Slot DROP INDEX parent_Slot_idx;
-- ALTER IGNORE TABLE Slot DROP INDEX name_Slot_idx;
CREATE INDEX parent_Slot_idx ON Slot(parent);
CREATE INDEX name_Slot_idx ON Slot(name_);

-- Indexes on SpecLink
-- ALTER IGNORE TABLE SpecificationLink DROP INDEX binding_SLnk_idx;
-- ALTER IGNORE TABLE SpecificationLink DROP INDEX spec_SLnk_idx;
...
-- ALTER IGNORE TABLE TelephoneNumber DROP INDEX parent_Phone_idx;
CREATE INDEX parent_Phone_idx ON TelephoneNumber(parent);


-- Indexes on User
-- ALTER IGNORE TABLE User_ DROP INDEX lastNm_User_idx;
CREATE INDEX lastNm_User_idx ON User_(personName_lastName);


-- Indexes on Person
-- ALTER IGNORE TABLE Person DROP INDEX lastNm_Person_idx;
