...
public class CodeValidation {
	...
	private void build_mime_map() throws XdsInternalException {
		...
		for (Pair<String,String> code : codes) {
			String ext = mimeTypeCodeSet.getExt((String)code.first, (String)code.second);
			if (ext == null) throw new XdsInternalException("CodeValidation.java: Configuration Error: Cannot find ext for mime type:" + (String)code.first );
			mime_map.put((String)code.first, ext);
			ext_map.put(ext, (String)code.first);
		}
	}
