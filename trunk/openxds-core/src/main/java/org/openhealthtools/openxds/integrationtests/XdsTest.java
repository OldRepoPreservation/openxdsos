...
public abstract class XdsTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		if (is == null) { 
			throw new Exception("Cannot load test.properties"); 
		}
...
//      .createConfigurationContextFromFileSystem(repository, axis2xml);
        ...
        Class theClass = ConfigurationContextFactory.class;
        
        System.out.println(ConfigurationContextFactory.class.getClassLoader());
         ConfigurationContext configctx = 
        		 ConfigurationContextFactory.createConfigurationContextFromFileSystem(axis2repo.getPath(), axis2testxml.getPath());
        return configctx; 
	}
