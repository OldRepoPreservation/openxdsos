...
public class AssigningAuthorityUtil {
    ...
    public static Identifier reconcileIdentifier(Identifier authority, IConnectionDescription connection) {
        List<org.openhealthtools.openexchange.datamodel.Identifier> identifiers = connection.getAllIdentifiersByType("domain");
        for (org.openhealthtools.openexchange.datamodel.Identifier idNew : identifiers) {
    ...
    public static boolean validateDomain(Identifier id, IConnectionDescription connection) {
         ...
         if (log.isInfoEnabled()) {
	         ...
	         for (org.openhealthtools.openexchange.datamodel.Identifier identifier : identifiers) {
