...
public class ModuleManager {
	...
	/**
	 * The factory method to get {@link XdsRepositoryService} for fileRepository. 
	 * @return the singleton {@link XdsRepositoryService} instance
	 */
	public static XdsRepositoryService getXdsFileRepository() {
		return (XdsRepositoryService)getInstance().getBean("fileRepository");
	}
